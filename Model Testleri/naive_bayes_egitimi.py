...
from sklearn.naive_bayes import MultinomialNB  # Naive Bayes import edildi
...
pipeline = Pipeline([
    ...
    ('naive_bayes', MultinomialNB())  # Naive Bayes modelini kullandık
])
...
param_grid = {
    ...
    'naive_bayes__alpha': [0.5, 1, 2]  # Naive Bayes için alpha parametresi
}
...
joblib.dump(grid_search.best_estimator_, 'csv_dosyaları/en_iyi_model.pkl')

# 9. Modeli Yükleyip Test Etme (isteğe bağlı)
loaded_model = joblib.load('csv_dosyaları/en_iyi_model.pkl')
