...
from sklearn.neighbors import KNeighborsClassifier  # k-NN sınıfı import edildi
...
pipeline = Pipeline([
    ...
    ('knn', KNeighborsClassifier())  # k-NN modelini kullandık
])
...
joblib.dump(grid_search.best_estimator_, 'csv_dosyaları/en_iyi_model_knn.pkl')

# 9. Modeli Yükleyip Test Etme (isteğe bağlı)
loaded_model = joblib.load('csv_dosyaları/en_iyi_model_knn.pkl')
